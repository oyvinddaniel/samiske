...
export function ProfileAboutTab({
  ...
  return (
    <div className="space-y-6">
      {/* User Info Summary */}
      {(username || tagline || (socialLinks && socialLinks.length > 0) || (interests && interests.length > 0)) && (
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            {username && (
              <div>
                <p className="text-sm font-medium text-gray-500">Brukernavn</p>
            ...
            {tagline && (
              <div>
                ...
                <p className="text-gray-900">{tagline}</p>
              </div>
            )}
                ...
                <div className="flex flex-wrap gap-2">
                  {socialLinks.map((link, i) => (
                    ...
                    >
                      ...
                      <span>{link.label || formatSocialType(link.type)}</span>
                    </a>
                  ))}
                </div>
              </div>
      ...
      {/* Sami Organizations */}
      <SamiOrganizations userId={userId} isEditable={isEditable} />
...
function formatSocialType(type: string): string {
  switch (type) {
    case 'instagram':
      return 'Instagram'
    case 'facebook':
