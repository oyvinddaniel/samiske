      ...
      {loading ? (
        ...
        <div className="space-y-1.5">
          {friends.map(friend => (
            <div
              key={friend.id}
              className="flex items-center gap-3 p-2.5 bg-white rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50/50 transition-all group"
            >
              ...
              {friend.phone_number ? (
                ...
                >
                  ...
                  <span className="hidden sm:inline">{friend.phone_number}</span>
                </a>
              ) : (
